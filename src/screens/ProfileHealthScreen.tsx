  ...
  return (
    ...
    >
      <div className="space-y-5 pb-8">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button
                ...
                style={{
                  borderColor:
                    activity === item.key ? green : 'rgba(16,32,26,0.06)',
        ...
        {/* Blood report upload */}
        <div
          className="rounded-[24px] bg-white p-5 border border-slate-100 text-center"
          style={{ boxShadow: '0 6px 18px rgba(16,32,26,0.03)' }}
        >
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider text-left mb-3">
            Report Synchronizer
          </h3>
          <div className="border-2 border-dashed border-slate-200 rounded-2xl p-6 bg-slate-50 flex flex-col justify-center items-center gap-3">
            ...
            {bloodReportUploaded ? (
              ...
              <>
                <div>
                  <span className="text-xs font-bold block text-slate-600">
                    Upload Blood Report
                  </span>
