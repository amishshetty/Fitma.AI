            ...
            style={{
              background:
                voiceStatus === 'error'
                  ...
                  : voiceStatus === 'idle'
                    ? 'linear-gradient(135deg, #9bb2a5, #6d8779)'
                    : 'linear-gradient(135deg, #34C759, #00C4B0)',
              boxShadow:
                voiceStatus === 'error'
                  ? '0 18px 48px rgba(239,68,68,0.3)'
                  : voiceStatus === 'idle'
                    ? '0 18px 48px rgba(155,178,165,0.3)'
                    : '0 18px 48px rgba(52,199,89,0.3)',
            }}
          >
        ...
        <div className="mt-11 flex h-14 items-end gap-2.5">
          {[28, 48, 34, 60, 42, 50, 32].map((height, index) => (
            <motion.div
              ...
              animate={{
                height:
                  voiceStatus === 'listening' ? [16, height, 18] : [8, 8, 8],
              }}
              transition={{
                duration: 0.85,
                delay: index * 0.08,
