    ...
    <ScreenShell
      ...
      footer={
        <div className="space-y-3">
          <PrimaryButton onClick={() => onNavigate('reminder-preview')}>
            ...
            onClick={async () => {
              try {
                if (!('Notification' in window)) {
                  alert(
                    'Push Notifications are not supported on this device/browser. Please make sure you have added this app to your Home Screen on iOS 16.4+.'
                  );
                  return;
                }
              ...
              {[
                {
                  ...
                  desc: 'Adaptive meal timing logs',
                },
                {
                  key: 'water',
                  label: 'Water Hydration logs',
                  desc: 'Adaptive glass indicators',
                },
                {
                  key: 'protein',
                  label: 'Protein Targets',
                  desc: 'Alerts when macros fall behind',
                },
                {
                  key: 'weekly',
                  label: 'Weekly Reports',
                  desc: 'Weekly health summaries',
                },
                {
                  key: 'weight',
                  label: 'Weight Check-ins',
                  desc: 'Goal progression checkups',
                },
              ].map((cat) => (
                <button
                  key={cat.key}
              ...
              <div className="flex bg-slate-50 dark:bg-muted p-1 rounded-2xl">
                {[
                  ...
                  <button
                    ...
                    style={{
                      background:
                        frequency === freq.key ? green : 'transparent',
