  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <div
          className="rounded-[28px] bg-card text-card-foreground p-5 border border-[#34C759]/12 text-center"
          ...
          <div className="mt-4 flex justify-center gap-6">
            <div>
              <ProgressRing
                value={Math.min(
                  100,
                  Math.round((finalCalorieBalance / dailyTarget) * 100)
                )}
                size={72}
            ...
            <div className="text-left flex flex-col justify-center">
              <span
                ...
                style={{ color: forecastData.color }}
              >
                {forecastData.mode}
              </span>
        ...
        <div
          className="rounded-[24px] bg-card text-card-foreground p-5 border border-[#34C759]/06"
        ...
        <div
          className="rounded-[24px] p-4.5 bg-[#f7fffe]"
          style={{ border: `1.5px dashed ${forecastData.color}30` }}
        >
          <div className="flex gap-3">
            ...
            <div>
              ...
              >
                {forecastData.message} Logging a dinner close to this budget
                helps maintain consistent leptin levels.
              </p>
            </div>
          </div>
        </div>
