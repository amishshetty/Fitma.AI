...
export default function ProgressWeightScreen({
  ...
  const progressPercent = Math.max(
    ...
    Math.min(
      100,
      Math.round(
        ((startWeight - userWeight) / (startWeight - goalWeight)) * 100
      )
    )
  );
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <div>
              ...
              <span className="text-xl font-black text-[#0ea5e9] block mt-1">
                {(startWeight - userWeight).toFixed(1)} kg
              </span>
            </div>
          </div>
            ...
            {[
              {
                ...
                detail: '75.4 kg on June 15',
                active: true,
              },
              {
                title: 'Halfway there!',
                detail: '72.7 kg target passed',
                active: userWeight <= 72.7,
              },
              {
                title: 'Under 71kg club',
                detail: 'Goal unlocked',
                active: userWeight < 71.0,
              },
            ].map((milestone, idx) => (
              <div key={idx} className="relative">
                <span
                  ...
                  style={{
                    background: milestone.active ? '#a855f7' : '#e2e8f0',
                  }}
                >
                  {milestone.active && '✓'}
                </span>
                <div>
                  <h4
                    ...
                    style={{ color: milestone.active ? ink : '#94a3b8' }}
                  >
                    {milestone.title}
                  </h4>
