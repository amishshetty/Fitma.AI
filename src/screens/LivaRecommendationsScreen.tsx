...
export default function LivaRecommendationsScreen({
  ...
  const recommendations = [
    {
      ...
      description:
        'Quinoa loaded with grilled chicken breast, avocado, and spinach.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: mealRecommendationImg,
      description:
        'Low-carb warm paneer tossed with bell peppers and microgreens.',
    },
  ];
  ...
  return (
    <ScreenShell
      ...
      subtitle="Personalized dinner ideas matching your protein target."
      onBack={onBack}
    >
