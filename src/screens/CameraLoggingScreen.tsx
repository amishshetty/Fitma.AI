      ...
      <div className="absolute left-0 right-0 top-0 z-10 flex items-center gap-3 px-6 pt-10">
        ...
        <div>
          ...
          <p className="text-sm text-white/70">
            Center the plate inside the guide.
          </p>
        </div>
      </div>
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 50% 45%, #27443a, #10201a 68%)',
        }}
      >
        <div
          className="absolute h-72 w-72 rounded-[36px]"
          style={{ border: '2px solid rgba(255,255,255,0.72)' }}
        />
        <div
          className="absolute h-56 w-56 rounded-full"
          style={{ border: '1px dashed rgba(52,199,89,0.8)' }}
        />
        <Utensils size={76} color="rgba(255,255,255,0.62)" />
        <motion.div
          animate={{ y: [-120, 120, -120] }}
          transition={{ duration: 2.4, repeat: Infinity }}
          className="absolute h-0.5 w-72 rounded-full bg-[#34C759]"
        />
      </div>
