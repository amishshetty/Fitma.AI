        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            style={{
              background: '#34C759',
              minHeight: '56px',
              boxShadow: '0 8px 16px rgba(52,199,89,0.2)',
            }}
          >
              ...
              <React.Fragment key={cat.key}>
                ...
                >
                  <div>
                    ...
                    <span
                      className="text-[11px] block mt-0.5 transition-colors"
                      style={{ color: '#8da396' }}
                    >
                      {cat.desc}
                    </span>
                  ...
                  <div
                    className={`transition-transform duration-200 ${prefs[cat.key] ? 'scale-100' : 'scale-90 opacity-40'}`}
                  >
                    {prefs[cat.key] ? (
                      <CheckCircle2
                        size={22}
