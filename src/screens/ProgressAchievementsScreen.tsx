      ...
      <div className="grid grid-cols-2 gap-3 pb-8">
        {achievements.map((ach, idx) => (
          ...
          >
            <div>
              <span
                className={`h-11 w-11 flex items-center justify-center rounded-2xl text-xl font-bold ${ach.color} ${!ach.unlocked && 'grayscale opacity-50'}`}
              >
                {ach.icon}
              </span>
              <h4
                className="text-xs font-black mt-3"
                style={{ color: ach.unlocked ? ink : '#94a3b8' }}
              >
                {ach.title}
              </h4>
            ...
            <div className="mt-4.5">
              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden mb-1.5">
                <div
                  ...
                  style={{
                    width: `${ach.count}%`,
                    background: ach.unlocked ? green : '#cbd5e1',
                  }}
                />
              </div>
