...
- CRITICAL: If logging a meal, set action.type to "MEAL_LOG" and set action.data.mealType to one of: "breakfast", "lunch", "dinner", "snack". IF the user explicitly mentions the meal (e.g., "for lunch", "in my dinner", "as a snack"), you MUST use that exact meal type. ONLY if they don't mention it should you guess based on the current time. NEVER use "unknown".
