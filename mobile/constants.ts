...
export const screenVariants = {
  enter: { x: 15, opacity: 0, scale: 0.99 },
  center: { 
    x: 0, 
    opacity: 1, 
    scale: 1,
...
export const quickOptions = [
  {
    mode: 'voice',
    title: 'Voice',
    description: 'Just tell Liva what you ate.',
    icon: Mic,
    tint: '#34C759',
    bg: '#ecfbf1',
  },
  {
    mode: 'camera',
    title: 'Camera',
    description: 'Snap a photo and let AI identify your meal.',
    icon: Camera,
    tint: '#0EA5E9',
    bg: '#e9f7ff',
  },
  {
    mode: 'text',
    title: 'Type',
    description: 'Type your meal naturally.',
    icon: Search,
    tint: '#7C3AED',
    bg: '#f3edff',
  },
